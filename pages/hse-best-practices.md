...
blocks:
  ...
  - type: split-image
    ...
    figure_src: /images/tipe-logo.jpg
    figure_alt: TIPE safety logo
  - type: callout
    variant: warning
  ...
  - type: split-image
    ...
    content: |
      ...
      - **Structural integrity** — frames and supports secure and free from defects
      - **Seams and fabric condition** — checking for wear, tears, and potential failure points
      - **Air retention** — verifying inflatables maintain appropriate pressure
      - **Anchor points** — examining security and wear on critical safety features
      - **Electrical systems** — blowers and connections checked for safety
  ...
  - type: split-image
    ...
    content: |
      ...
      Essex Inflatables has been conducting safety inspections since **1997** and became a certified PIPA Inspection Body in **2004**.
  ...
  - type: split-full
    ...
    left_content: |
      ...
      - **Cleaning and proper storage** extend equipment life and maintain safety standards
